# -*- coding: utf-8 -*-
"""
Created on Sun May 28 14:27:26 2023
...
diabetes = pickle.load(open("C:/Users/DELL/Desktop/MULTIPLE DISEASE DETECTION/diabetes_model.sav", "rb"))

heart_disease = pickle.load(open("C:/Users/DELL/Desktop/MULTIPLE DISEASE DETECTION/heart_disease_model.sav", "rb"))

parkinsons_disease = pickle.load(open("C:/Users/DELL/Desktop/MULTIPLE DISEASE DETECTION/parkinsons_disease_model.sav", "rb"))

breast_cancer = pickle.load(open("C:/Users/DELL/Desktop/MULTIPLE DISEASE DETECTION/breast_cancer_model.sav", "rb"))

lung_cancer = pickle.load(open("C:/Users/DELL/Desktop/MULTIPLE DISEASE DETECTION/lung_cancer_model.sav", "rb"))
...
with st.sidebar:
    ...
    selected = option_menu("Multiple Disease Detection System using Machine Learning", 
...
# code for Prediction
    ...
    if st.button("Diabetes Test Result"):
        ...
        if (diabetes_prediction[0] == 0):
          ...
          diabetes_diagnosis = " You have Diabetes. Please book appointment through the Link: https://apollosugar.com/book-an-appointment/ "
...
# getting the input data from the user
    ...
    if st.button('Heart Disease Test Result'):
        ...
        if (heart_prediction[0] == 0):
          ...
          heart_diagnosis = " You have Heart Problem. Please contact to doctor. Appointment link: https://www.fortisescorts.in/LP/leading-cardiology-hospital-okhla//?utm_source=google&utm_medium=cpc&utm_campaign=cardiacscience&gclid=CjwKCAjwue6hBhBVEiwA9YTx8OYz648U3VJ0hWbHcg10Mdk118sP8wCjx5nNdnB3X3Q4IxX4BtvIhBoCf8QQAvD_BwE "
...
# getting the input data from the user
    ...
    if st.button("Parkinson's Test Result"):
        ...
        if (parkinsons_prediction[0] == 0):
          ...
          parkinsons_diagnosis = " You have Parkinson's Disease. Please book appointment to the specialist: https://www.lybrate.com/delhi/treatment-for-parkinson-s-disease/aiims-delhi "
...
# getting the input data from the user
    ...
    if st.button("Breast Cancer Test Result"):
        ...
        if (breast_cancer_prediction[0] == 0):
         ...
         breast_cancer_check = " You have Breast Cancer. Please book appointment to the specialist: https://cytecare.com/best-cancer-hospital-bangalore/breast-cancer/?utm_phone=8377001724&utm_source=google&utm_medium=ppc&utm_campaign=breast-landing&utm_source=adwords&utm_campaign=FL+-+Text+Ads+-+Breast+Cancer+Treatment+-+BLR&utm_term=breast%20surgeon&utm_medium=ppc&hsa_cam=19482229183&hsa_kw=breast%20surgeon&hsa_ver=3&hsa_net=adwords&hsa_src=g&hsa_acc=2279222056&hsa_mt=b&hsa_grp=147443954120&hsa_ad=643741631232&hsa_tgt=kwd-89299593&gclid=CjwKCAjwjYKjBhB5EiwAiFdSfsT7IH3CUaimOLgGrQKgrIVqh5O_BA_oZ6bGd_zFN_ey_3D6RmVTFhoCrbIQAvD_BwE "
...
# code for Prediction
    ...
    if st.button("Lung Cancer Test Result"):
        ...
        if (lung_cancer_report[0] == 0):
          ...
          lung_cancer_result = " You have Lung Cancer. https://www.fortishealthcare.com/lp/campaign/best-oncology-hospital-shalimar-bagh?utm_source=google&utm_medium=cpc&utm_campaign=oncology&campaign=oncology-bangalore&gclid=CjwKCAjwvdajBhBEEiwAeMh1U1CEuFz6TDbbviPTkiRGa-dZg0ZwkmfhKt6yhyM2KL2BDdKBDzIS5xoCa3EQAvD_BwE "
